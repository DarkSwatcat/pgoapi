...
_FORTDATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='map_pokemon', full_name='pogoprotos.map.fort.FortData.map_pokemon', index=15,
...
_FORTDATA.fields_by_name['map_pokemon'].message_type = pogoprotos_dot_map_dot_pokemon_dot_map__pokemon__pb2._MAPPOKEMON
